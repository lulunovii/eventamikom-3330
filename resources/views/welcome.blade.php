    ...
    <nav class="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-gray-200 shadow-sm">
        <div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-1 sm:space-x-3">
                <a href="/" class="px-5 py-2.5 text-sm font-bold text-white bg-gradient-to-r from-indigo-600 to-purple-600 shadow-md shadow-indigo-200/50 rounded-full hover:shadow-lg hover:scale-105 transition-all">Home</a>
